...
+ Utilizzare Places Service come parte del flusso di lavoro di Experience Platform Launch {#use-places-launch-workflow}
   + [Utilizzare Places Service come parte del flusso di lavoro di Experience Platform Launch](use-places-launch-workflow/places-launch-workflow.md)
...
+ Utilizzare Places Service con altre soluzioni Adobe {#use-places-with-other-solutions}
