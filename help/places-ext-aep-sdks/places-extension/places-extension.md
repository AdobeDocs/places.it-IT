...
Passa al portale per sviluppatori Adobe per visualizzare la documentazione di [Estensioni Places SDK](https://developer.adobe.com/client-sdks/documentation/places/).
